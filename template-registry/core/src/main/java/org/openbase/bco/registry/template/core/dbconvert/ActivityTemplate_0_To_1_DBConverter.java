...
/**
 * Converter for activity templates which updates them to the new label structure.
 *
 * @author <a href="mailto:pleminoq@openbase.org">Tamino Huxohl</a>
 */
public class ActivityTemplate_0_To_1_DBConverter extends LabelDBConverter {
