...
public class AbstractBCOManagerTest extends AbstractBCOTest {
    ...
    protected static bco.openbase.app.app.manager.AppManagerLauncher appManagerLauncher;
    ...
    public static void setUpClass() throws Throwable {
        try {
            ...
            appManagerLauncher = new bco.openbase.app.app.manager.AppManagerLauncher();
