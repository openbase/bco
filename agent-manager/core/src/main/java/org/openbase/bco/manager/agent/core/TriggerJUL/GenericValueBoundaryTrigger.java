 ...
 * @param <DT> DataType
 */
public class GenericValueBoundaryTrigger<UR extends AbstractUnitRemote, DT extends GeneratedMessage> extends AbstractTrigger {
    ...
    public GenericValueBoundaryTrigger(final UR unitRemote, final double boundary, final TriggerOperation triggerOperation, ServiceType serviceType, String specificValueCall) throws InstantiationException {
        super();
