...
public class HeaterEnergySavingAgentTest extends AbstractBCOAgentManagerTest {
    ...
    public void testHeaterEnergySavingAgent() throws Exception {
        ...
        reedContactController.updateStateProvider(TimestampProcessor.updateTimestampWithCurrentTime(CLOSED));
        ...
        reedContactController.updateStateProvider(TimestampProcessor.updateTimestampWithCurrentTime(OPEN));
