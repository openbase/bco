 ...
 * @author mpohling
 */
public class JPAgentDatabaseDirectory extends AbstractJPDirectory {
	...
	public JPAgentDatabaseDirectory() {
	...
	protected File getPropertyDefaultValue() {
		return new File(System.getProperty("user.home")+"/.local/share/agent-manager/db");
	}

	@Override
	public String getDescription() {
		return "Specifies the agent database directory. Use  "+JPInitializeDB.COMMAND_IDENTIFIERS[0]+ " to auto create database directories.";
    }
}