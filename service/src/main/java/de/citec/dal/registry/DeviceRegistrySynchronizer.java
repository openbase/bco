...
//    private final Observer<DeviceRegistry> remoteChangeObserver;
...
//            };
//
//            this.remoteChangeObserver = (Observable<DeviceRegistryType.DeviceRegistry> source, DeviceRegistryType.DeviceRegistry data) -> {
//                sync();
//            };
        } catch (Exception ex) {
