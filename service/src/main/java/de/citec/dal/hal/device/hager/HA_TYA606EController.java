...
//    private final static String COMPONENT_POWER_CONSUMPTION_SENSOR = "PowerConsumptionSensor";
	...
	public HA_TYA606EController(final String id, final String label, final Location location) throws VerificationFailedException, InstantiationException {
		...
		data.setId(id);
		this.powerPlug_0 = new PowerPlugController(label, this, data.getPowerPlug0Builder());
		this.powerPlug_1 = new PowerPlugController(label, this, data.getPowerPlug1Builder());
		this.powerPlug_2 = new PowerPlugController(label, this, data.getPowerPlug2Builder());
		this.powerPlug_3 = new PowerPlugController(label, this, data.getPowerPlug3Builder());
		this.powerPlug_4 = new PowerPlugController(label, this, data.getPowerPlug4Builder());
		this.powerPlug_5 = new PowerPlugController(label, this, data.getPowerPlug5Builder());
		this.powerConsumptionSensor_0 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor0Builder());
		this.powerConsumptionSensor_1 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor1Builder());
		this.powerConsumptionSensor_2 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor2Builder());
		this.powerConsumptionSensor_3 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor3Builder());
		this.powerConsumptionSensor_4 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor4Builder());
		this.powerConsumptionSensor_5 = new PowerConsumptionSensorController(label, this, data.getPowerConsumptionSensor5Builder());
