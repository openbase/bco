...
public class GI_5133Controller extends AbstractDeviceController<GI_5133Type.GI_5133, GI_5133Type.GI_5133.Builder> {
    ...
    public GI_5133Controller(final String id, final String label, final String[] unitLabel, final Location location) throws RSBBindingException {
        ...
        this.button_4 = new ButtonController(COMPONENT_BUTTON_4, unitLabel[4], this, builder.getButton4Builder());
        this.button_5 = new ButtonController(COMPONENT_BUTTON_5, unitLabel[5], this, builder.getButton5Builder());
