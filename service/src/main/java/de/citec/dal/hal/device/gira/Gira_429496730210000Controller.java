 ...
 * @author mpohling
 */
public class Gira_429496730210000Controller extends AbstractOpenHABDeviceController<Gira_5133, Gira_5133.Builder> {
    ...
    public Gira_429496730210000Controller(final DeviceConfigType.DeviceConfig config) throws InstantiationException, CouldNotTransformException {
