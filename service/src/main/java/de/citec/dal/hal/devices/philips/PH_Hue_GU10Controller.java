 ...
 * @author mpohling
 */
public class PH_Hue_GU10Controller extends AbstractHardwareController<PH_Hue_GU10, PH_Hue_GU10.Builder> {
    ...
    public PH_Hue_GU10Controller(final String id, final Location location) throws RSBBindingException {
