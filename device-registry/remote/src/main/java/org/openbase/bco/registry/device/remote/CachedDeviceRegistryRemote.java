...
public class CachedDeviceRegistryRemote {
    ...
    private static final SyncObject REMOTE_LOCK = new SyncObject("CachedDeviceRegistryRemoteLock");
        ...
        synchronized (REMOTE_LOCK) {
            if (registryRemote != null) {
                try {
                    ...
                    ExceptionPrinter.printHistory(new FatalImplementationErrorException("Internal remote was locked by an external instance!", CachedDeviceRegistryRemote.class, ex), LOGGER);
                }
                registryRemote.shutdown();
                registryRemote = null;
            }
