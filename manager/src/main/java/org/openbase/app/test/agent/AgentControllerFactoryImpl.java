...
public class AgentControllerFactoryImpl implements AgentControllerFactory {
    ...
    private static final String PRESET_AGENT_PACKAGE_PREFIX = "bco.openbase.app.preset.agent";
    ...
    public AgentController newInstance(final UnitConfig agentUnitConfig) throws InstantiationException {
        ...
        //bco.openbase.app.preset.agent.PowerStateSynchroniserAgent
        //org.openbase.bco.dal.control.layer.unit.agent.preset.
