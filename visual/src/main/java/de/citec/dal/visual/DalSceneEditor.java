...
public class DalSceneEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sceneCreationPanel = new de.citec.dal.visual.util.SceneCreationPanel();
        sceneSelectorPanel = new de.citec.dal.visual.util.SceneSelectorPanel();
    ...
    private de.citec.dal.visual.util.SceneCreationPanel sceneCreationPanel;
    private de.citec.dal.visual.util.SceneSelectorPanel sceneSelectorPanel;
