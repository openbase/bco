...
public class PresenceLightAgent extends AbstractDelayedTriggerableAgent {
    ...
    public void init(final UnitConfig config) throws InitializationException, InterruptedException {
        ...
        try {
            ...
            registerTrigger(new GenericServiceStateValueTrigger(locationRemote, PresenceState.State.PRESENT, ServiceTemplateType.ServiceTemplate.ServiceType.PRESENCE_STATE_SERVICE), TriggerAggregation.OR);
         //   registerTrigger(new GenericBoundedDoubleValueTrigger<>(locationRemote, 1000, TriggerOperation.LOW_ACTIVE, ServiceType.ILLUMINANCE_STATE_SERVICE, "getIlluminance"), TriggerAggregation.OR);
