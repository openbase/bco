...
public class OpenHABCommandExecutor {
    ...
    private final Map<String, AppRemote> appRemoteMap;

    public OpenHABCommandExecutor(final Map<String, AppRemote> appRemoteMap) {
        this.appRemoteMap = appRemoteMap;
    }
    ...
    private class OpenhabCommandMetaData {
        ...
        public OpenhabCommandMetaData(OpenhabCommand command) throws CouldNotPerformException {
            ...
            try {
                appId = command.getItemBindingConfig().split(":")[1];
    ...
    public void receiveUpdate(OpenhabCommandType.OpenhabCommand command) throws CouldNotPerformException {
        ...
        appRemoteMap.get(metaData.getAppId()).setActivationState(ActivationStateTransformer.transform(command.getOnOff().getState()));
    }
}
