 ...
 */
public class PartyLightApp  /*extends AbstractApp*/ {
...
//
//    @Override
//    public void init(final AppConfigType.AppConfig config) throws InitializationException, InterruptedException {
//        super.init(config);
//        try {
