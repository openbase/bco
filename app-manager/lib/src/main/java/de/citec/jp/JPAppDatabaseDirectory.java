 ...
 * @author mpohling
 */
public class JPAppDatabaseDirectory extends AbstractJPDirectory {
	...
	protected File getPropertyDefaultValue() {
		return new File(System.getProperty("user.home")+"/.local/share/app-manager/db");
	}

	@Override
	public String getDescription() {
		return "Specifies the app database directory. Use  "+JPInitializeDB.COMMAND_IDENTIFIERS[0]+ " to auto create database directories.";
    }
}