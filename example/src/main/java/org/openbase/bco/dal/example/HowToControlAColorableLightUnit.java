...
public class HowToControlAColorableLightUnit {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Setup CLParser
        JPService.setApplicationName(HowToControlAColorableLightUnit.class.getSimpleName().toLowerCase());
