        ...
        try {
            ...
            if (authenticatedValue.hasTicketAuthenticatorWrapper()) {
                ...
                try {
                    ...
                    if (!AuthorizationHelper.canDo(unitConfig, ticketEvaluationWrapper.getUserId(), authorizationGroupMap, locationMap, authorizationType)) {
...
// todo enable again after fixing openbase/bco.authentication#61
                    ...
                    try {
                        if (JPService.getProperty(JPAuthentication.class).getValue()) {
                            ...
                            if (!AuthorizationHelper.canDo(unitConfig, null, null, locationMap, authorizationType)) {
