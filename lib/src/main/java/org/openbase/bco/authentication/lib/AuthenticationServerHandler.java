...
public class AuthenticationServerHandler {
     ...
     */
    public static TicketSessionKeyWrapper handleKDCRequest(final String id, final byte[] key, boolean isUser, final String clientNetworkAddress, final byte[] ticketGrantingServicePrivateKey) throws NotAvailableException, InterruptedException, CouldNotPerformException, IOException {
