...
public interface AuthenticationServerHandler {
     ...
     * @param clientPassword the hashed password of the client
     ...
     */
    public TicketSessionKeyWrapper handleKDCRequest(String clientID, byte[] clientPassword, String clientNetworkAddress, byte[] TGSSessionKey, byte[] TGSPrivateKey) throws NotAvailableException, CouldNotPerformException, InterruptedException, IOException;
