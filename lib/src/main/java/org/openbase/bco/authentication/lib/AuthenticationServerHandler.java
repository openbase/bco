...
public class AuthenticationServerHandler {
     ...
     * @param key hashed password or public key of the user or client respectively
     * @param isUser true if ticket was requested for a user. This is important for the encryption method to be chosen.
     ...
     */
    public static TicketSessionKeyWrapper handleKDCRequest(final String id, final byte[] key, boolean isUser, final String clientNetworkAddress, final byte[] ticketGrantingServiceSecretKey) throws NotAvailableException, InterruptedException, CouldNotPerformException, IOException {
     ...
     */
    public static TicketSessionKeyWrapper handleTGSRequest(final byte[] ticketGrantingServiceSecretKey, final byte[] serviceServerSecretKey, final TicketAuthenticatorWrapper wrapper) throws RejectedException, IOException, BadPaddingException {
     ...
     */
    public static TicketAuthenticatorWrapper handleSSRequest(final byte[] serviceServerSecretKey, final TicketAuthenticatorWrapper wrapper) throws RejectedException, IOException, BadPaddingException {
        // decrypt ticket and authenticator
