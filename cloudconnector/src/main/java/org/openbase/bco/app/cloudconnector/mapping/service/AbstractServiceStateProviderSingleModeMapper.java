...
public abstract class AbstractServiceStateProviderSingleModeMapper<SERVICE_STATE extends Message> extends AbstractServiceStateSingleModeMapper<SERVICE_STATE> {
    ...
    @Override
    public SERVICE_STATE getServiceState(String settingName) throws CouldNotPerformException {
        throw new CouldNotPerformException("Provider service cannot map from setting[" + settingName + "] to service state");
    }
}
