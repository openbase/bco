 ...
 * @author mpohling
 */
public class JPUserDatabaseDirectory extends AbstractJPDirectory {
    ...
    public JPUserDatabaseDirectory() {
    ...
    protected File getPropertyDefaultValue() {
        return new File(System.getProperty("user.home") + "/.local/share/user-registry/db");
    }

    @Override
    public String getDescription() {
        return "Specifies the user registry database directory. Use  " + JPInitializeDB.COMMAND_IDENTIFIERS[0] + " to auto create database directories.";
    }
}
