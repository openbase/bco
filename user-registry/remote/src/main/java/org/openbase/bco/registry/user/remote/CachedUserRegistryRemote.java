...
public class CachedUserRegistryRemote {
    ...
    private static final SyncObject REMOTE_LOCK = new SyncObject("CachedUserRegistryRemoteLock");
        ...
        synchronized (REMOTE_LOCK) {
            if (registryRemote != null) {
                try {
                    ...
                    ExceptionPrinter.printHistory(new FatalImplementationErrorException("Internal remote was locked by an external instance!", CachedUserRegistryRemote.class, ex), LOGGER);
                }
                registryRemote.shutdown();
                registryRemote = null;
            }
