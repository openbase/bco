...
public enum ServiceTypeTraitMapping {
    ...
    ACTIVATION_STATE_SERVICE_TRAIT_MAPPING(ServiceType.ACTIVATION_STATE_SERVICE, Trait.SCENE),
    ...
    TARGET_TEMPERATURE_STATE_SERVICE_TRAIT_MAPPING(ServiceType.TARGET_TEMPERATURE_STATE_SERVICE, Trait.TEMPERATURE_SETTING);
