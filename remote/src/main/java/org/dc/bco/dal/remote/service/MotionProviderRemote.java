 ...
 */
public class MotionProviderRemote extends AbstractServiceRemote<MotionProviderService> implements MotionProviderService {
    ...
    public MotionState getMotion() throws CouldNotPerformException, InterruptedException {
        for (MotionProviderService provider : getServices()) {
