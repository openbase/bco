 ...
 */
public class AuthorizationGroupPermissionConsistencyHandler extends AbstractProtoBufRegistryConsistencyHandler<String, UnitConfig, UnitConfig.Builder> {
    ...
    public PermissionConfig generateDefaultPermissionConfig(final UnitConfig authorizationGroupUnitConfig) {
        Builder permissionConfigBuilder = PermissionConfig.newBuilder();
        MapFieldEntry.Builder groupEntry = MapFieldEntry.newBuilder();
        groupEntry.setGroupId(authorizationGroupUnitConfig.getId());
        groupEntry.getPermissionBuilder().setWrite(true).setAccess(true).setRead(true);
        permissionConfigBuilder.addGroupPermission(groupEntry);
