 ...
 *
 * * Replace DEACTIVE by INACTIVE Service State for ActivationState.
 * * pretty formatting is applied for each service state entry
 *
 * @author <a href="mailto:pleminoq@openbase.org">Tamino Huxohl</a>
 */
public class SceneConfig_9_To_10_DBConverter extends AbstractDBVersionConverter {
    ...
    public SceneConfig_9_To_10_DBConverter(DBVersionControl versionControl) {
    ...
    private void upgradeScale(final JsonArray serviceStateDescriptionListArray) throws CouldNotPerformException {
        ...
        for (final JsonElement serviceStateDescriptionElement : serviceStateDescriptionListArray) {
            ...
            if (serviceState.has("value") && serviceState.get("value").getAsString().equals("DEACTIVE")) {

                // remove outdated value
                serviceState.remove("value");

                // add new value
                serviceState.addProperty("value", State.INACTIVE.name());
            }
