        ...
        return UnitConfig.newBuilder()
                ...
                .setPlacementConfig(PlacementConfig.newBuilder()
                        .setShape(Shape.newBuilder()
                                .addFloor(Vec3DDouble.newBuilder().setX(0).setY(0).build())
                                .addFloor(Vec3DDouble.newBuilder().setX(1).setY(0).build())
                                .addFloor(Vec3DDouble.newBuilder().setX(1).setY(1).build())
                                .addFloor(Vec3DDouble.newBuilder().setX(0).setY(1).build())
                                .build())
                        .build())
                .build();
    }
