 ...
 * @author mpohling
 */
public class OldDeviceManager {

    public final static String DATA_UPDATE = "DataUpdate";

    private static OldDeviceManager instance;
    ...
    public static final synchronized OldDeviceManager getInstance() {
        if (instance == null) {
            instance = new OldDeviceManager();
        }
        return instance;
    }
    ...
    public final void save() {
        ...
        for (DeviceClass deviceClass : deviceClassMap.values()) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not save " + deviceClass, ex);
            }
        }
        ...
        for (DeviceInstance deviceInstance : deviceInstanceMap.values()) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not save " + deviceInstance, ex);
            }
        }
        ...
        for (DeviceConfig deviceConfig : deviceConfigMap.values()) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not save " + deviceConfig, ex);
            }
        }
        ...
        for (DataStream dataStream : dataStreamMap.values()) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not save " + dataStream, ex);
            }
        }
        ...
        for (GlobalConfig globalConfig : globalConfigMap.values()) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not save " + globalConfig, ex);
            }
        }
    }
    ...
    public final void load() {
        ...
        for (File file : JPService.getAttribute(JPDeviceClassDatabaseDirectory.class).getValue().listFiles(fileFilter)) {
            try {
                ...
                Logger.getLogger(OldDeviceManager.class.getName()).log(Level.SEVERE, "Could not load " + file, ex);
            }
        }
