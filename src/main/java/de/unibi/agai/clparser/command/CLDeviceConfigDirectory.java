 ...
 * @author mpohling
 */
public class CLDeviceConfigDirectory extends AbstractCLDirectory {
	...
	protected File getCommandDefaultValue() {
		return new File(CLParser.getAttribute(CLDeviceManagerConfigPath.class).getValue(), "device-config");
	}
