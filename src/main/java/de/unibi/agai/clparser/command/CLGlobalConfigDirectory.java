 ...
 * @author mpohling
 */
public class CLGlobalConfigDirectory extends AbstractJPDirectory {
	...
	protected File getPropertyDefaultValue() {
		return new File(JPService.getAttribute(CLDeviceManagerConfigPath.class).getValue(), "global-config");
	}
