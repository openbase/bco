 ...
 */
public class CachedActivityRegistryRemote {
     ...
     * <p>
     * Note: If you have just modified the registry this method can return immediately if the task is not yet received by the registry controller.
        ...
        synchronized (REMOTE_LOCK) {
            ...
            if (registryRemote != null) {
                try {
                    ...
                    ExceptionPrinter.printHistory(new FatalImplementationErrorException("Internal remote was locked by an external instance!", CachedActivityRegistryRemote.class, ex), LOGGER);
                }
                registryRemote.shutdown();
                registryRemote = null;
            }
